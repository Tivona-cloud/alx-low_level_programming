 ...
 * @e_ident: A pointer at array containing ELF magic numbers
 ...
 * @e_ident: A pointer at array containing ELF class
 */
 ...
 * @elf: File descriptor from ELF file
 * Description: If the file can't be closed - exit is code 98
 */
...
/**
 * main - Displays the information contained in the ELF header at start of the ELF file
 * @argc: Number of arguments supplied to program
 * @argv: An array of pointers at arguments
 * Return: 0 on success
 * Description: If the file is not an ELF File/function fails - exit is code 98
 */
